...
@Schema(description = "사용자 루틴 설정 응답")
public record RoutineResponse(
        ...
        @Schema(
                description = "쉬는날로 적용할 요일 목록",
                example = "[\"FRIDAY\", \"SATURDAY\", \"SUNDAY\"]"
        )
        List<String> restDays,

        @Schema(description = "쉬는날 루틴 이름", example = "공강")
        ...
        @Schema(description = "쉬는날 기상 시간", example = "10:00")
        LocalTime weekendWakeTime,

        @Schema(description = "쉬는날 취침 시간", example = "02:00")
